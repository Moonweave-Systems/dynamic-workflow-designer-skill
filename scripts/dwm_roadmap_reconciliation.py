...
def audit_surfaces(surfaces: dict[str, str]) -> dict[str, Any]:
    ...
    require_term(blockers, surfaces, "docs/spec.md", "V96 metric ladder, V97 benchmark readiness, V98 wave operator, V99 wave receipt, V100 promotion evidence")
    ...
    require_term(blockers, surfaces, "docs/automation-roadmap.md", "V52-V100: Product Evidence And Control Deck")
