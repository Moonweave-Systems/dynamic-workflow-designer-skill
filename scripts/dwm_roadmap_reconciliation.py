...
def audit_surfaces(surfaces: dict[str, str]) -> dict[str, Any]:
    ...
    require_term(blockers, surfaces, "docs/automation-roadmap.md", "V52-V88: Product Evidence And Roadmap Reconciliation")
