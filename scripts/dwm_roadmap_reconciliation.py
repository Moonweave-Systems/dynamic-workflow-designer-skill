...
def audit_surfaces(surfaces: dict[str, str]) -> dict[str, Any]:
    ...
    require_term(blockers, surfaces, "docs/spec.md", "Last updated: 2026-06-20")
    ...
    require_term(blockers, surfaces, "docs/spec.md", "V96 metric ladder, V97 benchmark readiness, V98 wave operator, V99 wave receipt, V100 promotion evidence, V101 promotion route, V102 deterministic live-proof recorder, V103 live-proof comparison schema")
    ...
    require_term(blockers, surfaces, "docs/automation-roadmap.md", "V52-V103: Product Evidence And Control Deck")
