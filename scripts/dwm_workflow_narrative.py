...
def make_narrative(
    ...
    *,
    ...
    if roadmap_latest != "V100":
        add_blocker(blockers, "ERR_WORKFLOW_NARRATIVE_ROADMAP_STALE", "roadmap latest version is stale", surface="roadmap", actual=roadmap_latest, expected="V100")
    ...
    if activation_inputs.get("roadmap_latest_version") != "V100":
        add_blocker(blockers, "ERR_WORKFLOW_NARRATIVE_ACTIVATION_ROADMAP_STALE", "activation consumed a stale roadmap version", surface="activation", actual=activation_inputs.get("roadmap_latest_version"), expected="V100")
    ...
    stages = [
        stage(
            "chart",
            "Chart",
            "clear" if roadmap.get("decision") == "roadmap_reconciled" and roadmap_latest == "V100" and not roadmap.get("blocked_by") else "blocked",
