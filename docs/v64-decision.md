...
The accepted suite covers `pair-selection.json`, `pair-selection.md`,
clean pair root generation, V58 series generation, duplicate rejection recording,
stale pair blocking, unsafe clean root blocking, and insufficient
unique task blocking.
