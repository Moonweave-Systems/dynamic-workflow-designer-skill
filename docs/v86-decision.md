...
V86 keeps the Keelplane brand decision because it gives the project a stronger
public name without breaking the existing DWM Core, CLI, fixture, skill, and
artifact contracts.
